...
const Cart = (props) => {
  ...
  return (
    <Modal
      ...
      className="fixed bottom-0 right-0 inset-y-1/4  w-full  md:w-full   px-8 md:px-16 lg:px-36"
    >
          ...
          <table className="w-full text-sm text-center text-gray-900 ">
            ...
            {cartItem.map((item) => (
              <tr>
                ...
                <td scope="col" className="px-4  flex ">
                  <button
                    className="bg-blue-700 px-4 mx-2 rounded-lg text-lg text-white"
                    onClick={() => decrement(item)}
                  >
                    -
                  </button>
                  <span className="py-2 w-6">{item.count}</span>
                  <button
                    className="bg-blue-700 px-4 mx-2 rounded-lg text-lg text-white"
